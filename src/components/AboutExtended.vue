<template>
	<div class="col-span-full grid grid-cols-12 relative text-white mt-20 overflow-hidden">
		...
		<container>
			<div class="md:flex hidden items-center justify-center lg:my-24 mt-48">
			...
			<div class="grid lg:grid-cols-2 grid-cols-1 mt-48 mb-32 lg:gap-12">
				...
				<div class="py-6 lg:pr-12 font-raleway font-light">
					...
					<p class="lg:text-lg text-xl text-center mt-6 md:block hidden">
			...
			<div class="text-center mt-32 mb-96">
				...
				<div class="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 md:gap-8">
